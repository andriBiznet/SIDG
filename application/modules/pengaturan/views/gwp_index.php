					...
					<table class="table table-separate data table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 975px;">
						<thead>
							<tr role="row">
								...
								<th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 145px;" aria-label="Company Email: activate to sort column ascending">CH4 Equivalent</th>
								<th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 92px;" aria-label="Company Agent: activate to sort column ascending">N2O Equivalent</th>
						...
						<tbody>
							...
							<tr role="row" class="odd">
								...
								<td><?php echo $row->n2o; ?></td>
								<td nowrap="nowrap">	
									<a href="<?php echo site_url('/pengaturan/gwp/ubah/'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit details">
