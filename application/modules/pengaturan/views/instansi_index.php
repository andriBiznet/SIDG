					...
					<table class="table table-separate data table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 975px;">
						<thead>
							<tr role="row">
								...
								<th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 145px;" aria-label="Company Email: activate to sort column ascending">Alias</th>
								<th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 92px;" aria-label="Company Agent: activate to sort column ascending">Kode</th>
						...
						<tbody>
							...
							<tr role="row" class="odd">
								...
								<td nowrap="nowrap">	
									<a href="<?php echo site_url('/pengaturan/instansi/ubah/'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit details">
										<i class="la la-edit"></i>
									</a>
									<a href="<?php echo base_url('pengaturan/instansi/hapus/'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit details">
