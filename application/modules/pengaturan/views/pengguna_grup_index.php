					...
					<table class="table table-separate data table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 975px;">
						<thead>
							<tr role="row">
								...
								<th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 92px;" aria-label="Company Agent: activate to sort column ascending">Urutan</th>
						...
						<tbody>
							...
							<tr role="row" class="odd">
								...
								<td nowrap="nowrap">	
									<a href="<?php echo site_url('/pengaturan/pengguna_grup/ubah_hak_akses/'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit Menu Hak Akses">
										<i style="font-size: 1.1rem !important" class="flaticon-edit"></i>
									</a>
									<a href="<?php echo site_url('/pengaturan/pengguna_grup/ubah_data/'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit etails Data">
										<i class="la la-edit"></i>
									</a><?php if ($row->id > 1): ?>
									<a href="<?php echo base_url('pengaturan/pengguna_grup/hapus/'.$row->id); ?>" class="btn btn-sm btn-clean btn-icon" title="Hapus Data">
