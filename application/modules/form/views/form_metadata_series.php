 <div class="card card-custom">
			...
			<div class="row">
				<div class="col-sm-12">
					<table class="table table-separate data table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 975px;">
						...
						<?php 
						$editin=1;
						foreach ($metadata_series->result() as $row): ?>
						<tr role="row" class="odd">
							...
							<td nowrap="nowrap">	
								<button type="button" class="btn" data-toggle="modal" data-target="#myModal" data-judul="<?php echo $row->judul; ?>" data-sumber_data="<?php echo $row->sumber_data; ?>" data-keterangan="<?php echo $row->keterangan; ?>" data-nama_kontak="<?php echo $row->nama_kontak; ?>" data-no_hp_kontak="<?php echo $row->no_hp_kontak; ?>" data-email_kontak="<?php echo $row->email_kontak; ?>" data-eid="<?php echo $row->id; ?>" id="editid<?php echo $editin; ?>" onclick="edit_bil(<?php echo $editin; ?>)"><i class="la la-edit"></i></button>
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
				<div class="modal-header">
             	...
             	<form class="form-horizontal" action="<?php echo base_url('form/form/tambah_series/'.$id_form); ?>" method="post" enctype="multipart/form-data" role="form">
	...
	<div class="modal fade" role="dialog" aria-hidden="true" id="myModal" tabindex="-1" role="dialog" aria-labelledby="ModelLabelEdit" style="padding-right: 17px; display: none;" aria-modal="true">
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
				<div class="modal-header">
             	...
             	<form class="form-horizontal" action="<?php echo base_url('form/form/ubah_series/'.$id_form); ?>" method="post" enctype="multipart/form-data" role="form">
